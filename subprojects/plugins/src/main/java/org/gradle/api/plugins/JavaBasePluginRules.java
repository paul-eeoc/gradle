...
class JavaBasePluginRules implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        BridgedBinaries binaries = configureSourceSetDefaults(project.getTasks(), javaConvention);
    ...
    private BridgedBinaries configureSourceSetDefaults(final TaskContainer tasks, final JavaPluginConvention pluginConvention) {
