...
import org.gradle.api.publish.maven.MavenPomMailingListContainer;
...
public class DefaultMavenPom implements MavenPomInternal, MavenPomLicenseContainer, MavenPomDeveloperContainer, MavenPomContributorContainer, MavenPomMailingListContainer {
    ...
    @Override
    public void mailingLists(Action<? super MavenPomMailingListContainer> action) {
        action.execute(this);
    }
